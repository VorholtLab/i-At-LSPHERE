function [ActRxns, GFSumRes, DPsAll] = gapFilling_cl(pathmodel,NumAlt,mingrRate,indRxnsToCheck,tagMin,time)
...
if ~isempty(rxnsToCheck)
    ...
    [resultStat,ActRxns,DPsAll] = gfbiomass(model,indUSE,NumAlt,time,tagMin,tagMin);
end
